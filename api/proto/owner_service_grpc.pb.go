...
const (
	OwnerService_Create_FullMethodName      = "/mygrpcservice.OwnerService/Create"
	OwnerService_Read_FullMethodName        = "/mygrpcservice.OwnerService/Read"
	OwnerService_Update_FullMethodName      = "/mygrpcservice.OwnerService/Update"
	OwnerService_Delete_FullMethodName      = "/mygrpcservice.OwnerService/Delete"
...
type OwnerServiceClient interface {
	Create(ctx context.Context, in *CreateOwnerRequest, opts ...grpc.CallOption) (*CreateOwnerResponse, error)
	Read(ctx context.Context, in *ReadOwnerRequest, opts ...grpc.CallOption) (*ReadOwnerResponse, error)
	Update(ctx context.Context, in *UpdateOwnerRequest, opts ...grpc.CallOption) (*UpdateOwnerResponse, error)
	Delete(ctx context.Context, in *DeleteOwnerRequest, opts ...grpc.CallOption) (*DeleteOwnerResponse, error)
...
func (c *ownerServiceClient) Create(ctx context.Context, in *CreateOwnerRequest, opts ...grpc.CallOption) (*CreateOwnerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateOwnerResponse)
	err := c.cc.Invoke(ctx, OwnerService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ownerServiceClient) Read(ctx context.Context, in *ReadOwnerRequest, opts ...grpc.CallOption) (*ReadOwnerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadOwnerResponse)
	err := c.cc.Invoke(ctx, OwnerService_Read_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ownerServiceClient) Update(ctx context.Context, in *UpdateOwnerRequest, opts ...grpc.CallOption) (*UpdateOwnerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateOwnerResponse)
	err := c.cc.Invoke(ctx, OwnerService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ownerServiceClient) Delete(ctx context.Context, in *DeleteOwnerRequest, opts ...grpc.CallOption) (*DeleteOwnerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteOwnerResponse)
	err := c.cc.Invoke(ctx, OwnerService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OwnerServiceServer interface {
	Create(context.Context, *CreateOwnerRequest) (*CreateOwnerResponse, error)
	Read(context.Context, *ReadOwnerRequest) (*ReadOwnerResponse, error)
	Update(context.Context, *UpdateOwnerRequest) (*UpdateOwnerResponse, error)
	Delete(context.Context, *DeleteOwnerRequest) (*DeleteOwnerResponse, error)
...
func (UnimplementedOwnerServiceServer) Create(context.Context, *CreateOwnerRequest) (*CreateOwnerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedOwnerServiceServer) Read(context.Context, *ReadOwnerRequest) (*ReadOwnerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (UnimplementedOwnerServiceServer) Update(context.Context, *UpdateOwnerRequest) (*UpdateOwnerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedOwnerServiceServer) Delete(context.Context, *DeleteOwnerRequest) (*DeleteOwnerResponse, error) {
...
func _OwnerService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OwnerService_Create_FullMethodName,
	}
...
func _OwnerService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadOwnerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OwnerServiceServer).Read(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OwnerService_Read_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OwnerServiceServer).Read(ctx, req.(*ReadOwnerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OwnerService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OwnerService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OwnerService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OwnerService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OwnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Read",
			Handler:    _OwnerService_Read_Handler,
		},
		{
			MethodName: "Update",
