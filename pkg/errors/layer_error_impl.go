...
func newLayerCreator(l log.Logger) LayerErrorImpl {
	return LayerErrorImpl{
		log: l,
	}
}
...
func (lei *LayerErrorImpl) NewHandlerError(
	err error,
	translation string,
	code codes.Code,
) AppError {
...
// function is the error thrown, the code is a error code for the port and the string passed to the function
// is the translation that is sent back and is translated using I18N.
func (lei *LayerErrorImpl) NewDomainError(
	err error,
	translation string,
	code codes.Code,
) AppError {
...
// function is the error thrown, the code is a error code for the port and the string passed to the function
// is the translation that is sent back and is translated using I18N.
func (lei *LayerErrorImpl) NewRepositoryError(
	err error,
	translation string,
	code codes.Code,
) AppError {
...
// function is the error thrown, the code is a error code for the port and the string passed to the function
// is the translation that is sent back and is translated using I18N.
func (lei *LayerErrorImpl) NewInfrastructureError(
	err error,
	translation string,
	code codes.Code,
) AppError {
...
// function is the error thrown, the code is a error code for the port and the string passed to the function
// is the translation that is sent back and is translated using I18N.
func (lei *LayerErrorImpl) NewClientError(
	err error,
) AppError {
	return AppError{
		err:         err,                            // The error that is being thrown.
...
func (lei *LayerErrorImpl) NewInternalError(
	err error,
) AppError {
	return AppError{
		err:         err,                            // The error that is being thrown.
...
// It takes a error parameters and returns a new AppError. The error passed to the
// function is the error thrown. It will use a translation of SomethingWentWrong and use a internal error code.
func (lei *LayerErrorImpl) NewDatabaseError(
	err error,
) AppError {
	return AppError{
		err:         err,                            // The error that is being thrown.
